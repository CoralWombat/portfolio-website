                ...
                <div className='mx-8 grid grid-cols-1 gap-4 lg:grid-cols-2 max-w-screen-lg lg:m-auto'>
                    <List
                        ...
                        items={[
                            ...
                            <p>PostgreSQL &nbsp;<Tag level={3} /></p>,
                            <p>Neo4J &nbsp;<Tag level={3} /></p>,
                            <p>Git &nbsp;<Tag level={3} /></p>,
                            <p>Tailwind CSS &nbsp;<Tag level={3} /></p>,
                            <p>Lombok &nbsp;<Tag level={3} /></p>,
                            <p>Hibernate &nbsp;<Tag level={2} /></p>,
                            <p>SQL &nbsp;<Tag level={2} /></p>,
                            <p>MongoDB &nbsp;<Tag level={2} /></p>,
                            <p>Redis &nbsp;<Tag level={2} /></p>,
                            <p>Mockito &nbsp;<Tag level={2} /></p>,
