    ...
    return (
      <div className="mb-32">
        ...
        <div className="mx-8 grid grid-cols-1 gap-4 lg:grid-cols-2 max-w-screen-lg lg:m-auto">
          <Card
            mainTitle="Major Swiss Bank (2)"
            subTitle="Aug 2022 - Present"
            subSubTitle="as Full Stack Developer"
            icon={<GiSwissArmyKnife />}
            content={this.produceContent(
              "The project covering a pool of resources for a major swiss bank's Wealth Management system. My task was to implement new requirements, fix issues (both on back-end and front-end) and optimize database queries.",
          ...
          <Card
            ...
            content={this.produceContent(
              ...
              [
                "Java",
                "Spring Boot",
                "Oracle Weblogic 12c, later WildFly",
                "Oracle Database",
                "Docker",
              ]
            )}
